...
export const translations = {
  fr: {
    ...
    // Dashboard & Widgets
    widgetSystemHealth: "Santé Système",
    widgetFavorites: "Accès Rapide (Favoris)",
    widgetRecentActivity: "Activité Récente",
    configureDashboard: "Configurer le Tableau de bord",
    storageUsed: "Stockage Utilisé",
    camerasOnline: "Caméras en ligne",
    camerasOffline: "Caméras hors ligne",
    alarmsToday: "Alarmes aujourd'hui",
    noFavoritesYet: "Aucun favori enregistré. Ajoutez-en depuis la liste des caméras.",
    noRecentActivity: "Aucune activité récente.",
    quickUnlock: "Déverrouiller",
    quickView: "Visualiser",
    
    // Reports module
    reportType: "Type de rapport",
    reportAudit: "Rapport d'audit",
    reportActivity: "Rapport d'activité",
    reportCameraAvailability: "Disponibilité caméras",
    filterPeriod: "Période",
    filterOperator: "Opérateur",
    filterDevice: "Équipement",
    generateReport: "Générer le rapport",
    exportCSV: "Exporter CSV",
    exportPDF: "Imprimer / PDF",
    reportPeriodToday: "Aujourd'hui",
    reportPeriodYesterday: "Hier",
    reportPeriodLast7Days: "7 derniers jours",
    reportPeriodCustom: "Personnalisé",
    reportOperatorAll: "Tous les opérateurs",
    reportDeviceAll: "Tous les équipements",
    reportResultsCount: "{{count}} enregistrement(s) trouvé(s)",
    columnOperator: "Opérateur",
    columnDate: "Date & Heure",
    columnAction: "Action",
    ...
    columnCamera: "Caméra",
    columnUptime: "Taux de disponibilité",
    columnLatency: "Latence Moyenne",
    columnPacketLoss: "Perte de paquets",
  ...
  en: {
    ...
    // Dashboard & Widgets
    widgetSystemHealth: "System Health",
    widgetFavorites: "Quick Access (Favorites)",
    ...
    noFavoritesYet: "No favorites saved. Add some from the camera tree list.",
    ...
    reportCameraAvailability: "Camera availability",
    filterPeriod: "Period",
    ...
    reportPeriodLast7Days: "Last 7 Days",
    reportPeriodCustom: "Custom Range",
    reportOperatorAll: "All operators",
    reportDeviceAll: "All devices",
    reportResultsCount: "{{count}} record(s) found",
    ...
    columnCamera: "Camera",
    columnUptime: "Uptime Rate",
    columnLatency: "Avg Latency",
    columnPacketLoss: "Packet Loss",
    columnEvent: "Event"
  }
};
